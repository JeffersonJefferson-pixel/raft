...
func TestElectionLeaderDisconnect(t *testing.T) {
	...
	if newTerm <= origTerm {
		t.Errorf("want new term > origTerm, got %d and %d", newTerm, origTerm)
	}
}
...
func TestElectionLeaderAndAnotherDisconnect(t *testing.T) {
	...
	// disconnect leader and another server.
	h.DisconnectPeer(origLeaderId)
...
func TestElectionFollowerComesBack(t *testing.T) {
	...
	// re-election occurred when follower comes back, so new term should be larger than original term.
